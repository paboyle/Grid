...
#undef LOAD_CHI_BODY
#undef LOAD_CHI
#undef DO_TWIST_0L_1H
#undef DO_TWIST_1L_0H
#undef LOAD_CHI_SETUP
#undef LOAD_CHIMU_GPARITY_INPLACE_TWIST
#undef LOAD_CHI_GPARITY_INPLACE_TWIST
#undef LOAD_CHI_GPARITY
#undef LOAD_CHIMU_GPARITY
#undef MULT_2SPIN_BODY  
#undef MULT_2SPIN
#undef MULT_2SPIN_GPARITY
#undef PERMUTE_DIR
#undef XP_PROJ  
#undef YP_PROJ  
#undef ZP_PROJ  
...
#undef Chimu_32 
#undef HAND_DOP_SITE
#undef HAND_DOP_SITE_DAG
#undef HAND_DOP_SITE_INT
#undef HAND_DOP_SITE_DAG_INT
#undef HAND_DOP_SITE_EXT
#undef HAND_DOP_SITE_DAG_EXT
#undef HAND_SPECIALISE_EMPTY
#undef HAND_SPECIALISE_GPARITY
#undef HAND_SPECIALISE_GPARITY
#undef INSTANTIATE_THEM
